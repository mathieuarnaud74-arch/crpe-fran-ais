...
export const metadata: Metadata = {
  title: "Domaines des mathématiques",
  description: "Explorez les 5 domaines du programme de mathématiques au CRPE.",
};
    ...
    <div className="space-y-6">
      ...
      <Panel className="border-border bg-gradient-panel">
        <div className="flex flex-col gap-5 xl:flex-row xl:items-end xl:justify-between">
          <div>
            <Badge tone="accent">{data.subjectLabel}</Badge>
            <h1 className="mt-3 font-serif text-3xl font-semibold text-ink sm:mt-4 sm:text-4xl">Mathématiques</h1>
          </div>
          <div className="flex flex-wrap gap-3">
            <ButtonLink href="/tableau-de-bord" variant="secondary">
              Tableau de bord
            </ButtonLink>
            <ButtonLink href="/exercices?subject=Mathematiques">Catalogue complet</ButtonLink>
          </div>
        </div>
      </Panel>
