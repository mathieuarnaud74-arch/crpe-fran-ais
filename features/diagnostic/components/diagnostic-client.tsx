        ...
        <div className="grid gap-6 xl:grid-cols-[1.15fr_0.85fr]">
          <Panel>
            ...
            <p className="mt-2 text-sm leading-7 text-muted">
              Le diagnostic devient utile quand il dit où reprendre, et pas seulement combien vous avez
              réussi.
            </p>
              ...
              <div className="mt-5 space-y-3">
                {strengths.length > 0 ? (
                  ...
                  <p className="text-sm leading-7 text-muted">
                    Aucun sous-domaine n&apos;est encore totalement sécurisé. Ce n&apos;est pas bloquant
                    : le plus utile est de commencer par les priorités ci-dessous.
                  </p>
                )}
              </div>
            </Panel>
