            ...
            <p className="mt-3 text-sm leading-7 text-muted">
              {hasDiagnostic ? (
                ...
                <>
                  ...
                  <strong className="text-ink">environ 15 minutes par matière</strong>, puis vous oriente vers les
            ...
            >
              ...
              <p className="mt-1 text-xs leading-5 text-muted">
                {hasDiagnostic
                  ...
                  : "Français et maths, profil par sous-domaine, priorités identifiées. ~15 min par matière."}
              </p>
            </div>
            <div
              className={`rounded-[1.25rem] border px-4 py-4 ${
