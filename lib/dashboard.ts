...
function buildDailyActivity(attempts: AttemptInput[]): DailyActivityEntry[] {
...
function buildScoreEvolution(attempts: AttemptInput[]): ScoreEvolutionEntry[] {
...
function computeEarnedBadges(ctx: {
