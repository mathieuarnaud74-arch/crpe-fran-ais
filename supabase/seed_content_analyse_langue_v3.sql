...
'{"mode":"single_choice","value":"c"}'::jsonb,
'« Injuste » est attribut du sujet « cette décision », relié par le verbe d''état « sembler ». Critère décisif : un attribut du sujet est lié au sujet par un verbe attributif (être, sembler, paraître, devenir, rester, avoir l''air, passer pour...) et le caractérise. À distinguer : l''épithète liée est directement accolée au nom (« une décision injuste ») ; l''épithète détachée est séparée par des virgules (« Cette décision, injuste, a surpris tout le monde »). Ces trois fonctions de l''adjectif — épithète liée, épithète détachée, attribut — sont fondamentales à distinguer et à justifier au CRPE.',
'valide','CRPE Français — Analyse de la langue V3','premium',true),
...
'[{"id":"a","label":"Attribut du sujet avec verbe d''état implicite"},{"id":"b","label":"Épithète liée de « elle »"},{"id":"c","label":"Épithète détachée (prédicat second), apposée au sujet"},{"id":"d","label":"Complément de manière du verbe « s''endormit »"}]'::jsonb,
'{"mode":"single_choice","value":"c"}'::jsonb,
'« Fatiguée » est une épithète détachée (ou prédicat second / apposition adjectivale) : séparée par une virgule, elle renvoie au sujet « elle » et exprime une circonstance concomitante à l''action principale. On peut la reformuler : « Elle s''endormit parce qu''elle était fatiguée » ou « Comme elle était fatiguée, elle s''endormit ». Elle diffère de l''attribut du sujet (qui exige un verbe d''état : « elle paraissait fatiguée ») et de l''épithète liée (directement accolée : « Elle, fatiguée, s''endormit » n''est pas liée). Ce prédicat second est une structure très productive en stylistique littéraire — attendu au CRPE.',
'valide','CRPE Français — Analyse de la langue V3','premium',true),
