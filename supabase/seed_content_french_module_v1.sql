...
(
  ...
  null,
  '[{"id":"a","label":"perturbent"},{"id":"b","label":"perturbe"},{"id":"c","label":"perturbes"}]'::jsonb,
...
(
  ...
  null,
  '[{"id":"a","label":"aident"},{"id":"b","label":"aide"},{"id":"c","label":"aider"}]'::jsonb,
  '{"mode":"single_choice","value":"b"}'::jsonb,
...
(
  ...
  null,
  '[{"id":"a","label":"un COD"},{"id":"b","label":"un attribut du sujet"},{"id":"c","label":"un complement du nom"}]'::jsonb,
  '{"mode":"single_choice","value":"b"}'::jsonb,
...
(
  ...
  null,
  '[{"id":"a","label":"un complement circonstanciel de lieu"},{"id":"b","label":"un attribut du sujet"},{"id":"c","label":"un COD"}]'::jsonb,
...
(
  ...
  null,
  '[{"id":"a","label":"verrions"},{"id":"b","label":"verrons"},{"id":"c","label":"voyons"}]'::jsonb,
  '{"mode":"single_choice","value":"b"}'::jsonb,
...
(
  ...
  null,
  '[{"id":"a","label":"ferons"},{"id":"b","label":"ferions"},{"id":"c","label":"faisons"}]'::jsonb,
  '{"mode":"single_choice","value":"b"}'::jsonb,
...
(
  ...
  null,
  '[{"id":"a","label":"futur"},{"id":"b","label":"conditionnel"},{"id":"c","label":"subjonctif"}]'::jsonb,
  '{"mode":"single_choice","value":"b"}'::jsonb,
...
(
  ...
  null,
  '[{"id":"a","label":"est"},{"id":"b","label":"soit"},{"id":"c","label":"sera"}]'::jsonb,
  '{"mode":"single_choice","value":"b"}'::jsonb,
...
(
  ...
  null,
  '[{"id":"a","label":"Je dirais que cette reponse est juste."},{"id":"b","label":"Demain, je dirai la verite."},{"id":"c","label":"Je dis toujours la verite."}]'::jsonb,
  '{"mode":"single_choice","value":"a"}'::jsonb,
...
(
  ...
  '[{"id":"a","label":"Sur le banc"},{"id":"b","label":"Dans l''armoire"},{"id":"c","label":"Sous la table"}]'::jsonb,
  '{"mode":"single_choice","value":"a"}'::jsonb,
...
(
  ...
  '[{"id":"a","label":"Il fait probablement froid."},{"id":"b","label":"Il est midi."},{"id":"c","label":"Le personnage est en vacances."}]'::jsonb,
  '{"mode":"single_choice","value":"a"}'::jsonb,
...
(
  ...
  null,
  '[{"id":"a","label":"Une addition"},{"id":"b","label":"Une opposition"},{"id":"c","label":"Une cause"}]'::jsonb,
  '{"mode":"single_choice","value":"b"}'::jsonb,
...
(
  ...
  '[{"id":"a","label":"Une entree sous l''orage"},{"id":"b","label":"La salle informatique"},{"id":"c","label":"Une recette de cuisine"}]'::jsonb,
  '{"mode":"single_choice","value":"a"}'::jsonb,
...
(
  ...
  '[{"id":"a","label":"Il est amuse."},{"id":"b","label":"Il est tendu ou en colere."},{"id":"c","label":"Il s''endort."}]'::jsonb,
  '{"mode":"single_choice","value":"b"}'::jsonb,
...
(
  ...
  null,
  '[{"id":"a","label":"La cause"},{"id":"b","label":"Le but"},{"id":"c","label":"La consequence"}]'::jsonb,
  '{"mode":"single_choice","value":"b"}'::jsonb,
...
(
  ...
  null,
  '[{"id":"a","label":"Une reformulation"},{"id":"b","label":"Une opposition"},{"id":"c","label":"Une conclusion"}]'::jsonb,
  '{"mode":"single_choice","value":"a"}'::jsonb,
...
(
  ...
  null,
  '[{"id":"a","label":"Le jury corrige les copies avec attention."},{"id":"b","label":"Les copies sont corrigees avec attention par le jury."},{"id":"c","label":"Le jury a corrige les copies."}]'::jsonb,
  '{"mode":"single_choice","value":"b"}'::jsonb,
...
(
  ...
  null,
  '[{"id":"a","label":"Les erreurs releveront le correcteur."},{"id":"b","label":"Les erreurs seront relevees par le correcteur."},{"id":"c","label":"Les erreurs sont relevees par le correcteur."}]'::jsonb,
  '{"mode":"single_choice","value":"b"}'::jsonb,
...
(
  ...
  null,
  '[{"id":"a","label":"Les copies"},{"id":"b","label":"seront relues"},{"id":"c","label":"par les formateurs"}]'::jsonb,
...
(
  ...
  null,
  '[{"id":"a","label":"C''est la regle que le professeur explique."},{"id":"b","label":"C''est le professeur que la regle explique."},{"id":"c","label":"C''est la regle qui le professeur explique."}]'::jsonb,
  '{"mode":"single_choice","value":"a"}'::jsonb,
...
(
  ...
  null,
  '[{"id":"a","label":"Comprenez-vous cette consigne ?"},{"id":"b","label":"Vous comprenez-vous cette consigne ?"},{"id":"c","label":"Cette consigne comprenez-vous ?"}]'::jsonb,
  '{"mode":"single_choice","value":"a"}'::jsonb,
...
(
  ...
  null,
  '[{"id":"a","label":"Le deplacement en fin de phrase ou en tete de phrase."},{"id":"b","label":"Le remplacement par un pronom sujet."},{"id":"c","label":"L''accord du verbe avec ce groupe."}]'::jsonb,
  '{"mode":"single_choice","value":"a"}'::jsonb,
...
(
  ...
  null,
  '[{"id":"a","label":"Dire seulement que c''est faux."},{"id":"b","label":"Chercher ce que l''eleve a compris ou non de l''accord."},{"id":"c","label":"Passer immediatement a une autre notion."}]'::jsonb,
  '{"mode":"single_choice","value":"b"}'::jsonb,
...
(
  ...
  null,
  '[{"id":"a","label":"Leur demander seulement de relire en silence."},{"id":"b","label":"Enseigner explicitement des strategies comme anticiper, verifier et inferer."},{"id":"c","label":"Corriger uniquement les mots mal lus."}]'::jsonb,
  '{"mode":"single_choice","value":"b"}'::jsonb,
...
(
  ...
  null,
  '[{"id":"a","label":"Le faire copier une seule fois."},{"id":"b","label":"Le faire rencontrer et reutiliser dans plusieurs contextes."},{"id":"c","label":"Le faire memoriser hors de toute phrase."}]'::jsonb,
  '{"mode":"single_choice","value":"b"}'::jsonb,
...
(
  ...
  null,
  '[{"id":"a","label":"Les laisser ecrire sans preparation puis corriger a la fin."},{"id":"b","label":"Prevoir un temps de planification, de mise en texte puis de revision."},{"id":"c","label":"Corriger a leur place des la premiere phrase."}]'::jsonb,
  '{"mode":"single_choice","value":"b"}'::jsonb,
...
(
  ...
  null,
  '[{"id":"a","label":"Parce qu''il permet de faire apparaitre des regularites et des contrastes."},{"id":"b","label":"Parce qu''il remplace toute manipulation."},{"id":"c","label":"Parce qu''il evite d''avoir a justifier les regles."}]'::jsonb,
  '{"mode":"single_choice","value":"a"}'::jsonb,
...
(
  ...
  null,
  '[{"id":"a","label":"La vitesse seule."},{"id":"b","label":"Une lecture suffisamment exacte, rapide et expressive pour soutenir la comprehension."},{"id":"c","label":"La capacite a recopier vite."}]'::jsonb,
  '{"mode":"single_choice","value":"b"}'::jsonb,
