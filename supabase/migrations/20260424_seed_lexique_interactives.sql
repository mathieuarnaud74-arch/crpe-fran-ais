...
INSERT INTO public.exercises (
  ...
  NULL,
  '[{"id":"s1q3w1","label":"malheureux"},{"id":"s1q3w2","label":"plate-bande"},{"id":"s1q3w3","label":"bricolage"},{"id":"s1q3w4","label":"essuie-glace"},{"id":"s1q3w5","label":"illisible"},{"id":"s1q3w6","label":"rouge-gorge"}]'::jsonb,
  ...
  'Mal-heureux (préfixe mal-), bricolage (bricol-er + suffixe -age, dérivation suffixale transparente) et il-lisible (préfixe il- + suffixe -ible) sont des dérivés. Plate-bande, essuie-glace et rouge-gorge sont des composés réunissant deux éléments autonomes. Éduscol recommande de travailler explicitement ces procédés dès le cycle 2 pour développer la conscience morphologique.',
  'Classer « bricolage » comme mot simple ou composé. Le mot est formé par dérivation suffixale à partir du verbe « bricoler » : bricol-er → bricol-age (suffixe -age indiquant l''action ou le résultat).',
  'valide',
  'CRPE Français — Lexique',
  'free',
  true
...
INSERT INTO public.exercises (
  ...
  NULL,
  '[{"id":"s1q7w1","label":"lenteur"},{"id":"s1q7w2","label":"parapluie"},{"id":"s1q7w3","label":"lentement"},{"id":"s1q7w4","label":"gratte-ciel"},{"id":"s1q7w5","label":"décoller"},{"id":"s1q7w6","label":"semainier"},{"id":"s1q7w7","label":"chasse-neige"}]'::jsonb,
  ...
  'Lent-eur (suffixe -eur), lente-ment (suffixe -ment) et semain-ier (suffixe -ier) sont des suffixés. Para-pluie (préfixe para- « contre ») et dé-coller (préfixe dé-) sont des préfixés. Gratte-ciel et chasse-neige sont des composés verbe + nom. Les programmes Éduscol recommandent l''utilisation de familles de mots pour consolider ces apprentissages.',
