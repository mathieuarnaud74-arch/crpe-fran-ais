...
INSERT INTO public.exercises (
  ...
  'Facile',
  'qcm',
  'Dans la phrase suivante, quel déterminant possessif renvoie à un possesseur pluriel ?',
  ...
  'Le déterminant possessif « leur » renvoie à un possesseur pluriel (ils/elles) : l''institutrice est celle du groupe. « Ses » est aussi un déterminant possessif, mais il renvoie à un possesseur singulier (il/elle) — ce sont ses copies à elle. « Aux » est un article défini contracté (à + les) et « la » est un article défini. Au cycle 3, les programmes Éduscol demandent que les élèves sachent distinguer les différentes catégories de déterminants.',
  'Les élèves hésitent souvent entre « leur » et « ses » car les deux sont des déterminants possessifs. La question cible spécifiquement le possesseur pluriel, ce qui désigne sans ambiguïté « leur ». Attention aussi à ne pas confondre « leur » déterminant possessif avec « leur » pronom personnel COI (comme dans « je leur parle »).',
  'valide',
...
INSERT INTO public.exercises (
  ...
  '{"mode":"single_choice","value":"a"}'::jsonb,
  'Le déterminant « plusieurs » est un déterminant indéfini : il indique une quantité imprécise sans déterminer exactement le nombre d''élèves. « Chaque » est un déterminant indéfini à valeur distributive : il envisage les éléments d''un ensemble un par un. « Un » est un article indéfini (et non un déterminant indéfini au sens strict). « La » est un article défini.',
