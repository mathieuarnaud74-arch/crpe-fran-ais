...
INSERT INTO public.exercises (
  ...
  'Sujet blanc CRPE — Épreuve de mathématiques n°3', 'Avance', 'reponse_courte',
  'Un élève de CM1 effectue la multiplication posée 23 × 14 et trouve 115 au lieu de 322. En analysant son calcul posé, on constate qu''il a bien calculé 23 × 4 = 92, mais a ensuite calculé 23 × 1 = 23 au lieu de 23 × 10 = 230 (il n''a pas décalé d''un rang), puis additionné 92 + 23 = 115. Quel est le nom de cette erreur en didactique des mathématiques et comment y remédier ?',
  NULL,
  NULL,
