...
INSERT INTO public.exercises (
  ...
  NULL,
  NULL,
  '{"mode":"categories","categories":["GS (groupe sujet)","GV (groupe verbal)","GC (groupe circonstanciel)"],"items":[{"text":"Le vieux marin","category":"GS (groupe sujet)"},{"text":"racontait ses aventures aux enfants","category":"GV (groupe verbal)"},{"text":"chaque soir","category":"GC (groupe circonstanciel)"},{"text":"sur le port","category":"GC (groupe circonstanciel)"}]}'::jsonb,
