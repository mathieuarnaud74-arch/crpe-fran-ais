...
INSERT INTO public.exercises (
  ...
  NULL,
  '{"mode":"free_text","acceptableAnswers":["bois","doigt","fois","froid","joie","loi","moi","noix","pois","poisson","soi","soie","soir","toi","toit","trois","voie","voir","voix","croire","devoir","espoir","histoire","mémoire","oiseau","poivre","noir","poisson","boire","armoire","miroir","poire","baignoire"]}'::jsonb,
...
INSERT INTO public.exercises (
  ...
  NULL,
  '{"mode":"free_text","acceptableAnswers":["kr","cr","/kʁ/","kʁ","cr-"]}'::jsonb,
...
INSERT INTO public.exercises (
  ...
  NULL,
  '{"mode":"free_text","acceptableAnswers":["3","trois"]}'::jsonb,
...
INSERT INTO public.exercises (
  ...
  NULL,
  '{"mode":"free_text","acceptableAnswers":["livre","un livre","le livre"]}'::jsonb,
...
INSERT INTO public.exercises (
  ...
  NULL,
  NULL,
  '{"mode":"free_text","acceptableAnswers":["résider","demeurer"]}'::jsonb,
...
INSERT INTO public.exercises (
  ...
  NULL,
  NULL,
  '{"mode":"free_text","acceptableAnswers":["bagnole","caisse","tire","une bagnole","une caisse","une tire"]}'::jsonb,
