...
INSERT INTO public.exercises (
  ...
  NULL,
  '[{"id":"a","label":"Environ 38,60 €"},{"id":"b","label":"Environ 48,61 €"},{"id":"c","label":"Environ 64,40 €"},{"id":"d","label":"Environ 51,50 €"}]',
  '{"mode":"single","value":"b"}',
  'Étape 1 — Volume total : rayon = 4/2 = 2 m. V = π × r² × h = 3,14 × 4 × 1,2 = 15,072 m³. Étape 2 — Volume d''eau (3/4) : 15,072 × 3/4 = 15,072 × 0,75 = 11,304 m³. Étape 3 — Coût : 11,304 × 4,30 = 48,607 ≈ 48,61 €. Ce problème croise : géométrie (volume du cylindre), fractions (3/4), conversions (m³ → litres si besoin), et proportionnalité (coût). C''est typiquement le niveau d''un problème CRPE.',
