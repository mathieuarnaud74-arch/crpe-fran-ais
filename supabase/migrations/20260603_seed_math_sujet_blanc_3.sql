...
INSERT INTO public.exercises (
  ...
  'Difficile',
  'qcm',
  'Un train part de la ville A à 9 h 00 et roule à 120 km/h vers la ville B. Un autre train part de B à 9 h 30 et roule à 150 km/h vers A. La distance AB est de 465 km. À quelle heure les deux trains se croisent-ils ?',
  NULL,
  '[{"id":"a","label":"10 h 30"},{"id":"b","label":"11 h 00"},{"id":"c","label":"10 h 48"},{"id":"d","label":"11 h 12"}]',
  '{"mode":"single","value":"b"}',
  'Le train A part à 9 h 00. À 9 h 30 (quand B part), le train A a déjà parcouru 0,5 h × 120 = 60 km. La distance restante entre les deux trains est 465 − 60 = 405 km. Quand les deux trains roulent l''un vers l''autre, leurs vitesses s''additionnent : vitesse de rapprochement = 120 + 150 = 270 km/h. Temps avant croisement = 405 / 270 = 1,5 h = 1 h 30 min. Les trains se croisent à 9 h 30 + 1 h 30 = 11 h 00. Vérification : à 11 h 00, le train A roule depuis 2 h → 2 × 120 = 240 km. Le train B roule depuis 1 h 30 → 1,5 × 150 = 225 km. Total = 240 + 225 = 465 km ✓.',
