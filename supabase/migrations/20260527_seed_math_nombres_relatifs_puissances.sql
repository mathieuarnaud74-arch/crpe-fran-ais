...
INSERT INTO public.exercises (
  ...
  '{"mode":"single","value":"c"}',
  'Calculons chaque puissance : 2⁷ = 128, 3⁵ = 243, 4⁴ = 256. L''ordre croissant est donc : 2⁷ (128) < 3⁵ (243) < 4⁴ (256). Remarque utile : 4⁴ = (2²)⁴ = 2⁸ = 256, ce qui montre que 4⁴ est exactement le double de 2⁷ = 128. La maîtrise des puissances de 2 (2, 4, 8, 16, 32, 64, 128, 256, 512, 1024) est un atout au CRPE.',
  'Se tromper en confondant 2⁷ et 2⁸, ou en pensant que 3⁵ est plus grand que 4⁴. Calculer chaque puissance séparément est la méthode la plus sûre.',
  'valide',
  'Génération Claude — Terminologie Éduscol',
  'free',
  true
